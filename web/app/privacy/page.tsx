    ...
    return (
        <div className="container" style={{ maxWidth: '800px', padding: '4rem 2rem' }}>
            ...
            <main className="prose">
                <h1 className="text-2xl" style={{ marginBottom: '0.5rem' }}>Privacy Policy — Briefly AI – Smart Meeting Notes</h1>
                <p className="text-muted" style={{ marginBottom: '3rem' }}>Effective date: January 2, 2026</p>

                <section style={{ marginBottom: '2rem' }}>
                    <h2 className="text-xl" style={{ marginBottom: '1rem' }}>What Briefly AI does</h2>
                    <p className="text-muted">
                        Briefly AI is a Chrome extension and web application that allows you to record meetings and access those recordings in a private dashboard.
                    </p>
                </section>

                <section style={{ marginBottom: '2rem' }}>
                    <h2 className="text-xl" style={{ marginBottom: '1rem' }}>Information we collect</h2>
                    <p className="text-muted">We collect the following information when you use Briefly AI:</p>
                    <ul className="text-muted" style={{ listStyleType: 'disc', paddingLeft: '1.5rem', marginTop: '0.5rem' }}>
                        ...
                        <li><strong>Recordings:</strong> audio and video recordings you choose to capture using the Briefly AI Chrome extension.</li>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p className="text-muted">
                        Briefly AI is not intended for children under the age of 13.
                    </p>
                </section>
