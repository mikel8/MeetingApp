    ...
    return (
        <div className="container" style={{ maxWidth: '800px', padding: '4rem 2rem' }}>
            ...
            <main className="prose">
                <h1 className="text-2xl" style={{ marginBottom: '0.5rem' }}>Terms of Service — MeetingApp</h1>
                <p className="text-muted" style={{ marginBottom: '3rem' }}>Effective date: January 2, 2026</p>

                <p className="text-muted" style={{ marginBottom: '2rem' }}>
                    By using MeetingApp (the Chrome extension and web application), you agree to these Terms.
                </p>

                <section style={{ marginBottom: '2rem' }}>
                    <h2 className="text-xl" style={{ marginBottom: '1rem' }}>Use of the service</h2>
                    <p className="text-muted">
                        You may use MeetingApp to record meetings and store recordings in your private dashboard.
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p className="text-muted">
                        ...
                        You grant MeetingApp permission to store and process recordings solely for the purpose of providing the service.
                    </p>
                </section>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p className="text-muted">
                        You agree not to misuse the service, attempt unauthorized access, or use MeetingApp in violation of applicable laws.
                    </p>
                </section>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p className="text-muted">
                        MeetingApp is provided on an “as is” basis.
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p className="text-muted">
                        To the maximum extent permitted by law, MeetingApp is not liable for indirect, incidental, or consequential damages.
                    </p>
                </section>
